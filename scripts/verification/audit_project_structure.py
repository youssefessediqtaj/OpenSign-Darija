...
ROOT_DECISIONS: dict[str, tuple[str, str]] = {
    ...
    "artifacts": ("KEEP", "Generated reports plus protected local model/data evidence; large binaries remain ignored selectively."),
    ...
    ".gitignore": ("KEEP", "Keeps caches, raw data, and large generated binaries out of Git while allowing report/metadata evidence."),
        ...
        results.append(
            {
                ...
                "documentation_usage": "documented" if name in {"README.md", "docs", "NOTICE"} else "minimal",
...
def write_cleanup_reports(files: list[str]) -> None:
    ...
    retained_payload = {
        ...
        "retained_intentionally": [
            ...
            {"path": "artifacts/reports/", "reason": "Generated audit evidence; additive root-structure reports only for this pass."},
        ],
    }
    ...
    unused_payload = {
        ...
        "generated_at": datetime.now(UTC).isoformat(),
        "method": [
            "Existing dependency graph from scripts/verification/audit_repository_architecture.py.",
